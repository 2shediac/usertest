...
$string['welcome_info'] = 'Use this form to contact us.<br /><strong>Note:</strong> If you need to report an issue with our training site, please be sure to include a detailed description of the problem and if possible the steps you took to produce the issue.<br />
Thank you.<br />';

...
document.getElementById("ua_browser").innerHTML = 
    document.getElementsByName("cf_browser")[0].value = "<strong>" + b.name + "</strong> " + b.major + " (" + b.version + ")";
document.getElementById("ua_engine").innerHTML =
    document.getElementsByName("cf_engine")[0].value = "<strong>" + e.name + "</strong> (" + e.version + ")";
document.getElementById("ua_os").innerHTML = 
    document.getElementsByName("cf_os")[0].value = "<strong>" + o.name + "</strong> " + o.version;
...
';
        ...
        $mform->addElement('static', 'browser', 'Browser', "<span id='ua_browser'></span>");
        $mform->addElement('hidden', 'cf_browser', '');
        $mform->addElement('static', 'engine', 'Engine', "<span id='ua_engine'></span>");
        $mform->addElement('hidden', 'cf_engine', '');
        $mform->addElement('static', 'os', 'OS Type', "<span id='ua_os'></span>");
        $mform->addElement('hidden', 'cf_os', '');
        $mform->addElement('static', 'device', 'Device', "<span id='ua_device'></span>");

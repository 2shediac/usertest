<?php
    ...
    $messagehtml .=  '<br /><hr />'.format_text($fromform->cf_mailbody['text'],$fromform->cf_mailbody['format']);
    $messagehtml .= '<br /><hr />
    <h4>Client Info</h4>
    <table border="1" cellspacing="0" cellpadding="8" style="border: 1px solid #ccc; border-collapse: collapse">
    <tr>
    <td>Browser</td>
    <td>'.$fromform->cf_browser.'</td>
    </tr>
    <tr>
    <td>Engine</td>
    <td>'.$fromform->cf_engine.'</td>
    </tr>
    <tr>
    <td>OS Type</td>
    <td>'.$fromform->cf_os.'</td>
    </tr>
    <tr>
    <td>Device</td>
    <td>'.$fromform->cf_device.'</td>
    </tr>
    </table>';
    //print_object($fromform);
